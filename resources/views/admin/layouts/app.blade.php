...
<head>
    ...
    <title>@yield('pageTitle') - SOGE POS</title>
    ...
    <link rel="stylesheet" href="{{ asset('presets/admin/css/styles.css?') }}{{ rand() }}">
    <link rel="stylesheet" href="{{ asset('presets/admin/css/responsive.css?') }}{{ rand() }}">
    <!-- custom css -->
    @yield('css')
    <!-- modernizr css -->
...
<body>
    ...
    <div class="page-container">
        ...
        <footer>
            <div class="footer-area">
                <p>SOGEPOS © Copyright {{ date('Y')}}. All right reserved.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
    ...
    <script src="{{ asset('presets/admin/js/line-chart.js') }}"></script>
    <!-- all pie chart -->
    <script src="{{asset('presets/admin/js/pie-chart.js') }}"></script>
    <!-- others plugins -->
